class CreateResources < ActiveRecord::Migration
  def self.up
    ...
    Resource.create!({:name => '事件记录', :code => 'searches', :parent => central, :path => '/searches', :sequence => 21})
    Resource.create!({:name => '录音记录', :code => 'records', :parent => central, :path => '/records', :sequence => 22})

    system = Resource.create!({:name => '系统管理', :code => 'system', :sequence => 90})
    Resource.create!({:name => '机构管理', :code => 'departments', :parent => system, :path => '/departments/new', :sequence => 91})
    Resource.create!({:name => '用户管理', :code => 'users', :parent => system, :path => '/users', :sequence => 92})
    Resource.create!({:name => '系统日志', :code => 'logs', :parent => system, :path => '/logs', :sequence => 93})
    Resource.create!({:name => '公告管理', :code => 'notices', :parent => system, :path => '/notices', :sequence => 94})
  end
