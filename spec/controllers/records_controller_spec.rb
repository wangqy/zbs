...
describe RecordsController do
  ...
  it "should create a dail in record" do
    lambda do
      get :create, :kind => 'dail_in', :dail => '13988889999', :receive => '802', :wavfile => 'some_path', :uniqueid => '2009051822222212345678910'
  ...
  it "should create a dail out record" do
    lambda do
      get :create, :kind => 'dail_out', :dail => '802', :receive => '13988889999', :wavfile => 'some_path', :uniqueid => '2009051822222212345678910'
